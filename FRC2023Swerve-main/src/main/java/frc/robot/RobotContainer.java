...
public class RobotContainer {
  ...
  private void configureBindings() {
   ...
   // ileridon.whileTrue( Autos.driveAndSpin(drivebase));
    Trigger don = driverController.button(13);
    ...
    Trigger limehizalama = driverController.button(12);
    limehizalama.whileTrue(new msDrive(drivebase,
    () -> 0,
    () -> 0,
    ...
    */
    ...
    Trigger limeileri = driverController.button(14);
    ...
    Trigger intakeStopTrigger = driverController.button(3);
    ...
    intakeStopTrigger.onFalse(new IntakeSetCommand(intakeSubsystem, colorSensore, false, false, false,false));
